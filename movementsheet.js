    ...
    function nav(){
      if(snavshow == 0){
        ...
        div.style.border = "0.5px blue solid";
    ...
    function shownews(){
      ...
      if(test == "もっと見る" || test == "Read More"){
        if((loadfirst == 1 && countnews < 3 && loadednews > 0) || (loadfirst == 0 && loadednews > 0)){
          ...
          document.getElementById("news" + (parseInt(maxnews - loadednews))).style.height = "52.5px" ;
          loadednews -= 1;
          countnews += 1;
    ...
    function langchange(){
      if(lng == 0){
        ...
        document.getElementById('fade1').innerHTML = '<img src="img/1.jpg" width="100%" height="175px" alt="Name" title="Name"><div class="pdEmphasize" style="transform: rotateZ(45deg); opacity: 1;"><div class="pdEmText" style="transform: rotateZ(-45deg); opacity: 1; margin-left: 0px;"><b>New!</b></div></div><div class="pdEmArrow" style="transform: rotateZ(180deg); opacity: 1;"></div>Name<div class="product-description-line">Price：99980Yen ×3<br>Purchase：Gacha・buy<br>---<br>Pretty little necktie key ring.</div>';
        ...
        document.getElementById('scr').src = "img/moisshop_h1_2_EN_min.png";
      } else {
